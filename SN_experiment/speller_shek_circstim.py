...
def test(n_trials, code="onoff"):# modul gold codes 
    ...
    for i_trial in range(n_trials):
        ...
        # Trial
        keyboard.add_highlighter(target_key,color="yellow",lineWidth=6)        
        ...
        keyboard.add_highlighter(target_key,color = [0,0,0],lineWidth=7) # linewidth is increased to mask the highlighter at the end of a trial
