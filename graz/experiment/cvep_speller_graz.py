...
Python script for the creating the stimulus paradigm
"""
import json
import numpy as np
...
class Keyboard(object):
    ...
    def image_selector(self, name: str, size: tuple, pos, images=["white.png", "blue.png"], auto_draw = False):
        ...
        for image in images:           
            ...
            if name == 'stt': # opto tracker image should still be a square 
                ...
                print("image before cropping", image)
    ...
    def run(self, FR, shape_sequence, All_Images, codes, duration, cued_side, shape_change_time_sec,start_marker=None, stop_marker=None):
        """
        ...
        Args:
            ...
            shape_sequence (dict):
                A dictionary containing the shape sequences for the cued and non_cued side
            All_Images (dict):
        ...
        # get sequences
        cued_sequence = shape_sequence['cued_sequence']
        non_cued_sequence = shape_sequence['non_cued_sequence']
        ...
        for i in range(n_frames): 
            ...
            if cued_side == 'LEFT' :            
                ...
                if (i % (2*change_frames)) < change_frames: # logic for changing the shapes
                    ...
                    Dict_Images_right[shape_right_side][shape_right_side][0].draw()
            ...
            # right side has the cued shape sequence
                ...
                if (i % (2*change_frames)) < change_frames: 
                    ...
                    Dict_Images_left[shape_left_side][shape_left_side][0].draw() 
